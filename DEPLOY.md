...
Bitrix не отдаёт. Сделка, переданная в другой отдел, приносит туда и всю свою
историю движения; на странице «Движение» об этом написано прямо. Карточка без
ответственного не принадлежит ни одному отделу — её видит только администратор,
а «Качество данных» считает такие карточки отдельной строкой.
