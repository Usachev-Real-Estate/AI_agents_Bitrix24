...
# Обязательные поля Bitrix для проверки на "Подборе". Заполнить кодами UF.
BUYER_QUALIFICATION_FIELDS: tuple[tuple[str, str], ...] = (
    # ("UF_CRM_BUDGET_CODE", "бюджет"),
    # ("UF_CRM_DISTRICT_CODE", "район"),
    # ("UF_CRM_PROPERTY_TYPE_CODE", "тип объекта"),
)
