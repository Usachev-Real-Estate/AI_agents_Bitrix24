...
Что считается разговором. Только CALL и MEETING. TODO и TASKS_TASK — это
дело, заведённое себе, и задача, поставленная сотруднику; на портале их
5 902 за год, почти четверть всех действий. Засчитывать их работой значит
выдать лучшим работником того, кто аккуратно ведёт список дел и не звонит.
